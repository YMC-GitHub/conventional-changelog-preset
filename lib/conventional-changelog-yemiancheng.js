...
(function (global, factory) {
	...
	(global = global || self, global['conventional-changelog-yemiancheng'] = factory());
	...
	var delete_1 = function (obj, path) {
		if (!isObj(obj) || typeof path !== 'string') {
			return;
		}
	...
	function getWriterOpts() {
	  return {
	    ...
	    notesSort: compareFunc_1
	  };
	}

	var conventionalChangelog = q.all([parserOpts, writerOpts]).spread(function (parserOpts, writerOpts) { return ({ parserOpts: parserOpts, writerOpts: writerOpts }); });
	...
	var index = q.all([conventionalChangelog, parserOpts, recommendedBumpOpts, writerOpts]).spread(
	  function (conventionalChangelog, parserOpts, recommendedBumpOpts, writerOpts) { return ({
